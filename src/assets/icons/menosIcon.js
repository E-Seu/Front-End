...
const MenosIcon = ({ isPressed = false, width = 24, height = 24 }) => {
  if (isPressed) {
    ...
    return (
      ...
      >
        <Path 
          d="M15 12H9M7 3.33801C8.51945 2.45874 10.2445 1.99712 12 2.00001C17.523 2.00001 22 6.47701 22 12C22 17.523 17.523 22 12 22C6.477 22 2 17.523 2 12C2 10.179 2.487 8.47001 3.338 7.00001" 
          stroke="#888888" 
          strokeWidth="1.5" 
          strokeLinecap="round"
        />

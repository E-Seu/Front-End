...
import FixedRestaurantModal from '../components/FixedRestaurantModal';

const RegisterRestauranteFixo = ({ navigation }) => {
...
export default RegisterRestauranteFixo;